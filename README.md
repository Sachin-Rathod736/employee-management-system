...
Ensure that you have Java 25 installed on your local machine. If not, follow the instructions below:
...
- For Windows: Download OpenJDK 25 from https://jdk.java.net/25/ and follow the installation instructions.
